                    ...
                    <div class="row justify-content-md-center">
              			<div class="col-lg-12 inner-top inner-bottom">
                         	...
                         	<form method="POST" action="/booking/arrival">
								...
								<label for="eta">Estimated Time of Arrival (Z)</label>
        						<div class="input-group bootstrap-timepicker timepicker">
            						<input id="timepicker" type="text" class="form-control" name="eta" placeholder="All times are listed in Zulu" required/>
